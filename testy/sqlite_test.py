...
if __name__ == '__main__':
    ...
    # Stillage_test()
    # Pattern_item_test()
    # print("TEST OBSAHU TRIED OK - trval %s sekúnd" % (time.time() - start_time))
    #Test obsahu lokálnej databázy
    start_time = time.time()
    last_sync_db_test()
    over_data_general()
    over_data_User_Role()
    ...
    print("TEST OBSAHU SQLITE OK - trval %s sekúnd" % (time.time() - start_time))
    # Test obsahu vzdialenej datbázy