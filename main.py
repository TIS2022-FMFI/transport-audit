...
class GefcoApp(App):
    def build(self):
        ...
        choose_language = Button(text = 'Choose language', background_normal = 'normal.png',
                    background_down = 'down.png', background_color = (138/255,43/255,226/255,1),size_hint = (.2,None), pos = (350,70))
